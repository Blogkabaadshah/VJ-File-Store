...
BOT_USERNAME = environ.get("BOT_USERNAME", "Movies_Dhamaal_bot") # without @
...
CDB_NAME = environ.get("CDB_NAME", "Moviedhamaal")

# Database Information
DB_URI = environ.get("DB_URI", "mongodb+srv://Blogkabaadshah:Blogkaking@cluster0.tu29h.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
WEBSITE_URL = environ.get("WEBSITE_URL", "https://moviesdhamaalreviews.blogspot.com/2024/09/redirecting-to-your-link-code-credit.html") # For More Information Check Video On Yt - @Tech_VJ
